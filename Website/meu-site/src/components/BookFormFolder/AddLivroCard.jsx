    ...
    <div className="addlivro-overlay">
      <div className="addlivro-card">
        ...
        <form className="addlivro-form" onSubmit={handleSubmit}>
          ...
          <label>Páginas<input type="number" value={paginas} onChange={e=>setPaginas(e.target.value)} required /></label>
          <label>Autor
          ...
          <label>Ano de Publicação<input type="number" value={anoPublicacao} onChange={e=>setAnoPublicacao(e.target.value)} required /></label>
